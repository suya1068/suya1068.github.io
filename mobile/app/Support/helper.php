...
//            : $scheme . "://" . str_replace("m.", "", $_SERVER["HTTP_HOST"]) . $_SERVER["REQUEST_URI"];
    }
}
...
//        $result["image"] = empty($data["image"]) ? IMG_SERVER . "/mobile/main/top_visual/top_visual_08.jpg" : $data["image"];
...
if (!function_exists("starsWith")) {
    function startsWith($data, $needle) {
        return $needle === "" || strrpos($data, $needle, -strlen($data)) !== false;
    }
}
