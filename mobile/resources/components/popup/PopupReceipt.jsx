...
import PopupScheduleCancel from "./PopupScheduleCancel";
...
class PopupReceipt extends Component {
    ...
    onPopupPrintReceipt() {
        ...
        let url = `${__DESKTOP__}/reserve/receipt/${buy_no}?type=${type}`;
    ...
    onCancel() {
        ...
        Modal.show({
            ...
            content: <PopupScheduleCancel data={{ userType, buyNo, productNo: data.product_no || "", baseData: data }} />,
            onClose: () => {
                // Modal.close();
            }
        });
                    ...
                    if (item.status_type === "READY") {
                        buttonCancel = (
                            <div className="receipt__buttons">
                                <button className="_button _button__disable">결제 대기중입니다</button>
                            </div>
                        );
                    } else if (item.status_type === "CANCEL") {
                        buttonCancel = (
                            <div className="receipt__buttons">
                                <button className="_button _button__disable">결제가 취소되었습니다</button>
                            </div>
                        );
                    } else {
                        buttonCancel = (
                            <div className="receipt__buttons">
                                <button className="_button _button__white" onClick={this.onCancel}>취소하기</button>
                            </div>
                        );
                    }
                }
            ...
            <div className="popup__receipt">
                <div>
                    ...
                    {userType === "U" && data.paid_dt ?
                        <div className="receipt__buttons">
                            <button className="_button _button__white" onClick={this.onPopupPrintReceipt}>구매 영수증</button>
                        </div> : null
                    }
                ...
                <div className="receipt__close" onClick={() => Modal.close()}>확인</div>
            </div>
        );
    }
}
