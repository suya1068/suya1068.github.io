...
class ExampleReview extends Component {
    ...
    gaEvent(category_name, nick_name) {
        utils.ad.gaEvent("M_기업_메인", "작가후기", `${category_name}_${nick_name}`);
    }
    ...
    render() {
        ...
        return (
            <section className="main__example__review">
                <div className="main__row__title"><h1>포스냅 작가님들의<br />촬영사례를 살펴보세요!</h1></div>
