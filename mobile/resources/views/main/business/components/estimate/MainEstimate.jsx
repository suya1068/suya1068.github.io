...
import VirtualEstimate from "../../../../products/list/open/virtual_estimate/VirtualEstimate";
import * as virtualEstimateHelper from "../../../../products/list/open/virtual_estimate/virtualEstimateHelper";
import * as EstimateSession from "../../../../products/list/open/extraInfoSession";
import PopModal from "shared/components/modal/PopModal";
import { ADVICE_EXTRA_TEXT, PROPERTYS } from "../../../../products/list/open/virtual_estimate/virtual_estimate.const";
...
export default class MainEstimate extends Component {
    ...
    gaEvent(action) {
        ...
        utils.ad.gaEvent("M_기업_메인", action, currentCategory);
    }
