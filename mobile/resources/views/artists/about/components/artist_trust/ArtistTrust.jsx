...
export default class ArtistTrust extends Component {
    ...
    calculateHeight() {
        ...
        // const target = this.hide_info;
        const targetChildren = this.test_node;
        this.setState({
            moreHeight: targetChildren.clientHeight || 50
        });
    }
        ...
        return (
            <div className="artist-trust-component" id="artist-trust-component">
                ...
                <div className="hide-info" ref={node => { this.hide_info = node; }}>
                    <div className="test" ref={node => { this.test_node = node; }}>
