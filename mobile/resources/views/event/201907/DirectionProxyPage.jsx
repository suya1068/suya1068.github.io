...
class DirectionProxyPage extends Component {
    ...
    componentDidMount() {
        setTimeout(() => {
            AppDispatcher.dispatch({ type: CONST.GLOBAL_BREADCRUMB, payload: "제품 연출 대행 무료 이벤트" });
        }, 0);
    }
        ...
        if (message) {
            ...
            api.orders.insertAdviceOrders(params)
                .then(response => {
                    ...
                    // utils.ad.wcsEvent("4");
                    // utils.ad.gaEvent("M_기업메인", "", "하단상담신청");
    ...
    onMoveScroll(e) {
        ...
        window.scrollTo(0, window.pageYOffset + (rect.top - 50));
    }

    gaEvent() {
        utils.ad.gaEvent("M_광고", "이벤트_제품대행연출", "포스냅 둘러보기");
    }
            ...
            <div className="event__direction__proxy__page">
                <div className="event__section__01">
                    <div className="content__01">
                        <div className="logo"><img alt="logo" src={`${host}/event/201907/m_event_logo_01.png`} /></div>
                        <div className="txt01"><img alt="txt01" src={`${host}/event/201907/m_event_txt_01.png`} /></div>
                        <div className="txt02"><span>제품 촬영 때문에 고민하지마세요!</span></div>
                    </div>
                    <div className="bg01">
                        <Img image={{ src: "/event/201907/m_event_bg_01.jpg", type: "image" }} />
                    </div>
                </div>
                <div className="event__section__02">
                    ...
                    <div className="content__01">
                        <img alt="bg02" src={`${host}/event/201907/m_event_bg_02.png`} />
                        <div className="content__text">
                            <div className="txt01"><span>매</span><span>달</span> 상담건수만</div>
                            <img className="img__txt02" alt="txt02" src={`${host}/event/201907/m_event_txt_02.png`} />
                        </div>
                    </div>
                ...
                <div className="event__section__03">
                    ...
                    <div className="txt02"><img alt="txt02" src={`${host}/event/201907/m_event_txt_03.png`} /></div>
                    <div className="txt03">포스냅 전속 제품 촬영 작가님이<br />연출 대행을 무료로 진행해드립니다. </div>
                    <button className="txt04" onClick={this.onMoveScroll}>지금 신청하셔서 무료 상담 받아보세요!</button>
                </div>
                    ...
                    <div className="content__01">
                        <div className="step">
                            <div className="step__icon">
                                <span>01</span>
                                <div>
                                    <img alt="icon01" src={`${host}/event/201907/m_event_icon_01.png`} />
                                </div>
                            </div>
                        ...
                        <div className="step">
                            <div className="step__icon">
                                <span>02</span>
                                <div>
                                    <img alt="icon02" src={`${host}/event/201907/m_event_icon_02.png`} />
                                </div>
                            </div>
                            <div className="step__txt">
                                상담사에게<br />전화가 오면<br />
                        ...
                        <div className="step">
                            <div className="step__icon">
                                <span>03</span>
                                <div>
                                    <img alt="icon03" src={`${host}/event/201907/m_event_icon_03.png`} />
                                </div>
                            </div>
                            <div className="step__txt">
                                원하는<br />
                ...
                <div className="event__section__06">
                    <div className="content__01">
                        ...
                        <div className="txt01">
                            ...
                            <p>연출대행은 3개의 콘셉까지 무료로 진행 가능합니다.</p>
