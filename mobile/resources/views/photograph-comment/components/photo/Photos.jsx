                    ...
                    <div className="row mb-20">
                        <div className="columns col-12 text-center">
                            <div className="photograph-comment-button-group">
                                <div className="photograph-comment-button-group__item">
                                    <button
                                        className="f__button f__button__round f__button__theme__fill-pink"
                                ...
                                <div className="photograph-comment-button-group__item">
                                    <div className="photograph-comment-upload-btn">
                                        <button
                                            className="f__button f__button__theme__secondary"
                                        >이미지 등록하기</button>
                                        <input
                                            type="file"
                                            name="upload-file"
