                ...
                <div className="photograph-comment-card__body">
                    <div className="photograph-comment-service">
                        ...
                        <div className="photograph-comment-service__aside">
                            <Heart score={kind} disable={false} onSelect={value => this.setService("kind", value)} />
                        </div>
                    </div>
                    <div className="photograph-comment-service">
                        <div className="photograph-comment-service__content">
                        ...
                        <div className="photograph-comment-service__aside">
                            <Heart score={quality} disable={false} onSelect={value => this.setService("quality", value)} />
                        </div>
                    </div>
                    <div className="photograph-comment-service">
                        <div className="photograph-comment-service__content">
                        ...
                        <div className="photograph-comment-service__aside">
                            <Heart score={service} disable={false} onSelect={value => this.setService("service", value)} />
                        </div>
                    </div>
                    <div className="photograph-comment-service">
                        <div className="photograph-comment-service__content">
                        ...
                        <div className="photograph-comment-service__aside">
                            <Heart score={price} disable={false} onSelect={value => this.setService("price", value)} />
                        </div>
                    </div>
                    <div className="photograph-comment-service">
                        <div className="photograph-comment-service__content">
                        ...
                        <div className="photograph-comment-service__aside">
                            <Heart score={talk} disable={false} onSelect={value => this.setService("talk", value)} />
                        </div>
                    </div>
                    <div className="photograph-comment-service">
                        <div className="photograph-comment-service__content">
                        ...
                        <div className="photograph-comment-service__aside">
                            <Heart score={trust} disable={false} onSelect={value => this.setService("trust", value)} />
                        </div>
                    </div>
                </div>
            </section>
