...
class PortfolioVideoThumb extends Component {
                    ...
                    if (response[0]) {
                        ...
                        this.setStateData(() => {
                            return {
                                ...
                                backgroundImage: `url(${data.thumbnail_large})`
                            };
                        });
                    } else {
                        this.setDefault();
    ...
    render() {
        const { backgroundImage, runTime, backgroundPosition } = this.state;
        ...
        return (
            <div
                className="portfolio__video__thumb"
                style={{
                    backgroundImage,
                    ...
                    backgroundPosition,
                    backgroundColor: runTime ? "#000" : "transparent"
                }}
            >
