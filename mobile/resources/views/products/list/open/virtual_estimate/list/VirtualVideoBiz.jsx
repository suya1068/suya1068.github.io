...
export default class VirtualVideoBiz extends Component {
    ...
    composeActiveList(list, p_code, c_code) {
        return list.reduce((result, obj) => {
            ...
            const is_check = obj.CODE === "actor_casting"
                || obj.CODE === "h_m_casting"
                || obj.CODE === "plan_conti";

            // disabled 변경 로직
            if (c_code === "viral_video") {
                changeProp(["actor_casting", "h_m_casting", "plan_conti"], obj, false);
                changeProp(["interview_person"], obj, true);
                if (is_check) {
            ...
            if (c_code === "interview_video") {
                changeProp(["actor_casting", "h_m_casting", "plan_conti"], obj, true);
                changeProp(["interview_person"], obj, false);
                if (is_check) {
