            ...
            PROP: [
                {
                    ...
                    IMAGE: "/estimate/renew/fashion/image_01_2x.jpg",
                    NUMBER: true,
                    TEXT: false,
                    TYPE: "select",
                    PLACEHOLDER: "ex. 3",
                ...
                },
                {
                    ...
                    IMAGE: "/estimate/renew/fashion/image_02_2x.jpg",
                    NUMBER: false,
                    TEXT: false,
                    TYPE: "select",
                    PROP: [
            ...
            PROP: [
                {
                    ...
                    IMAGE: "/estimate/renew/fashion/image_05_2x.jpg",
                    NUMBER: false,
                    TEXT: false,
                    DEPTH: 1,
                    TYPE: "radio"
                },
                {
                    ...
                    IMAGE: "/estimate/renew/fashion/image_06_2x.jpg",
                    NUMBER: false,
                    TEXT: false,
                    DEPTH: 1,
                    TYPE: "radio"
                },
                {
                    ...
                    IMAGE: "/estimate/renew/fashion/image_07_2x.jpg",
                    NUMBER: false,
                    TEXT: false,
                    DEPTH: 1,
                    TYPE: "radio"
                },
                {
                    ...
                    GROUP: 1,
                    CAPTION: "국내성인모델/일반촬영\n기준으로 견적책정",
                    IMAGE: "/estimate/renew/fashion/image_03_2x.jpg",
                    NUMBER: false,
                    TEXT: false,
                    DEPTH: 1,
                    TYPE: "select"
                },
                {
                    ...
                    IMAGE: "/estimate/renew/fashion/image_04_2x.jpg",
                    NUMBER: false,
                    TEXT: false,
                    DEPTH: 1,
                    TYPE: "select"
            ...
            PROP: [
                {
                    ...
                    NAME: "디테일컷 필요",
                    CAPTION: "전체컷이 아닌 부분의\n상세 이미지 촬영",
                    IMAGE: "/estimate/renew/fashion/image_08_2x.jpg",
                    NUMBER: true,
                    TEXT: false,
                    DEPTH: 1,
                    PLACEHOLDER: "ex. 3",
                ...
                },
                {
                    ...
                    NAME: "리터치 추가 필요",
                    CAPTION: "기본제공 리터치 외의\n추가 리터치가 필요한 경우",
                    IMAGE: "/estimate/renew/fashion/image_09_2x.jpg",
                    NUMBER: true,
                    TEXT: false,
                    PLACEHOLDER: "ex. 3",
                    DEPTH: 1,
