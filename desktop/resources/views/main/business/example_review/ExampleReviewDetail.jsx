...
class ExampleReviewDetail extends Component {
                ...
                <div className="example__consult__modal">
                    <ConsultModal
                        ...
                        onConsult={pr => {
                            ...
                            this.insertAdvice(params, modal_name, gaData);
                        }}
    ...
    insertAdvice(params, modal_name, gaData) {
        ...
        if (chargeMaxCount - crc === 0) {
            ...
            api.orders.insertArtistOrder(params)
                .then(response => {
                    ...
                    this.externalEvents(page_type, gaData);
                    this.chargeCount.setCRC();
                    this.setState({
                        crc: this.chargeCount.getCRC()
                    });
    ...
    externalEvents(type, data) {
        let pageType = "";
        switch (type) {
            case "main": pageType = "기업_메인"; break;
            case "list": pageType = "기업_리스트"; break;
            case "detail": pageType = "기업_상세"; break;
            default:
        }

        if (pageType) {
            utils.ad.gaEvent(pageType, "촬영사례_상담신청", `${data.category}_${data.nick_name}`);
        }
