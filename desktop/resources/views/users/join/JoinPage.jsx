                    ...
                    <div>
                        <div className="join__container">
                            <div className="join__header">
                                <h1 className="header__title">이메일 회원가입</h1>
                            </div>
                            <div className="join__content">
                                ...
                                <div className="join__row">
                                    <Input
                                        ...
                                        regular={/\s/}
                                        placeholder="대문자,소문자,숫자,특수문자 중 3개를 포함한 조합으로 8자~15자"
                                        onChange={(e, n, v) => this.onChangeForm(n, v)}
                                        onValidate={(e, n, v) => this.onValidForm(n, v)}
                                    />
                                </div>
                                ...
                                <h2 className="title">비밀번호 재확인</h2>
                                <div className="join__row">
                                    <Input
                        ...
                        <div className="join__agree">
                            <div className="agree__content">
                                <strong>
                                    <a href="https://forsnap.com/policy/private" target="_blank">[개인정보 수집 및 이용동의]</a>
                                </strong>
                            </div>
                        ...
                        <div className="join__buttons">
                            <button className="_button _button__fill__yellow" onClick={this.onJoin}>가입하기</button>
                        </div>
                    </div>
                </div>
            </div>
