...
export default class VirtualFashion extends Component {
    ...
    composeActiveList(list, p_code, c_code) {
        return list.reduce((result, obj) => {
            obj.reduce((r, o) => {
                ...
                const is_check =
                    o.CODE === PROPERTYS.IS_RETOUCH_ADD.CODE
                    || o.CODE === PROPERTYS.IS_DETAIL_CUT.CODE;

                // disabled 변경 로직
                // // 누끼촬영
                if (c_code === SHOT_KIND_PROPERTY.NUKKI.CODE) {
                    helper.changeProp([PROPERTYS.NUKKI_CLOTHES_NUMBER.CODE, PROPERTYS.N_CLOTHES_P_NUMBER.CODE, PROPERTYS.NUKKI_KIND.CODE], o, false);
                    helper.changeProp([PROPERTYS.MODEL_TIME.CODE, PROPERTYS.MODEL_CASTING.CODE, PROPERTYS.H_M_CASTING.CODE], o, true);

                    if (o.CODE === PROPERTYS.NUKKI_KIND.CODE) {
                        helper.targetReduce(ob => helper.changeProp([NUKKI_KIND_PROPERTY.FLOOR_NUKKI.CODE, NUKKI_KIND_PROPERTY.MANNEQUIN_NUKKI.CODE, NUKKI_KIND_PROPERTY.GHOST_CUT.CODE], ob, false, "DEFAULT"), o);
                        helper.targetReduce(ob => helper.changeProp([NUKKI_KIND_PROPERTY.FLOOR_NUKKI.CODE], ob, true, "DEFAULT"), o);
                    }

                    if (o.CODE === PROPERTYS.MODEL_CASTING.CODE || o.CODE === PROPERTYS.H_M_CASTING.CODE) {
                        helper.targetReduce(ob => helper.changeProp([HAS_PROPERTY.NEED.CODE, HAS_PROPERTY.NEEDLESS.CODE], ob, false, "DEFAULT"), o);
                    }
                }
                // // 모델촬영
                if (c_code === SHOT_KIND_PROPERTY.MODEL_SHOT.CODE) {
                    helper.changeProp([PROPERTYS.NUKKI_CLOTHES_NUMBER.CODE, PROPERTYS.N_CLOTHES_P_NUMBER.CODE, PROPERTYS.NUKKI_KIND.CODE], o, true);
                    helper.changeProp([PROPERTYS.MODEL_TIME.CODE, PROPERTYS.MODEL_CASTING.CODE, PROPERTYS.H_M_CASTING.CODE], o, false);

                    if (o.CODE === PROPERTYS.NUKKI_KIND.CODE) {
                        helper.targetReduce(ob => helper.changeProp(["floor_nukki", "mannequin_nukki", "ghost_cut"], ob, false, "DEFAULT"), o);
                    }

                    if (o.CODE === PROPERTYS.MODEL_CASTING.CODE || o.CODE === PROPERTYS.H_M_CASTING.CODE) {
                        helper.targetReduce(ob => helper.changeProp([HAS_PROPERTY.NEED.CODE], ob, false, "DEFAULT"), o);
                        helper.targetReduce(ob => helper.changeProp([HAS_PROPERTY.NEEDLESS.CODE], ob, true, "DEFAULT"), o);
                    }
                }
                ...
                if (c_code === SHOT_KIND_PROPERTY.N_PLUS_M_SHOT.CODE) {
                    ...
                    if (o.CODE === PROPERTYS.NUKKI_KIND.CODE) {
                        helper.targetReduce(ob => helper.changeProp(["floor_nukki", "mannequin_nukki", "ghost_cut"], ob, false, "DEFAULT"), o);
                        helper.targetReduce(ob => helper.changeProp(["floor_nukki"], ob, true, "DEFAULT"), o);
                    }
                ...
                if (p_code === PROPERTYS.SHOT_KIND.CODE) {
                    ...
                    helper.changeProp([PROPERTYS.DETAIL_NUMBER.CODE, PROPERTYS.RETOUCH_NUMBER.CODE], o, true);
                }
    ...
    render() {
        const { list, total_price, prev_total_price, form, alphas, error, numbers, send_info, info, isAlphas } = this.state;
        ...
        return (
            <div>
                <VirtualEstimateView {...props} list={list} info={info} sendInfo={send_info} form={form} error={error} numbers={numbers} onActive={this.onActive} onChange={this.onChange} />
