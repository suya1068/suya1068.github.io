                ...
                <div className="container">
                    <div className="another__recommend__artist__head">
                        <div className="_modal__view__close">
                            <button className="recommend-close-btn" onClick={() => Modal.close("another_artist")}>
                                <img src={`${__SERVER__.img}/common/icon/white-close_2x.png`} alt="닫기" />
                            </button>
                        </div>
                        <div className="another__recommend__artist__info" >
                            {/*<p className="info-title">{title}</p>*/}
                            <p className="info-title">추가 상담신청 남은 횟수 : {restCount}회 (총 {chargeMaxCount}회)</p>
                            <p className="info-desc">현재
                                <span style={{ color: "#f7b500" }}>{restCount}명</span>
                                의 작가님께 추가 상담신청이 가능합니다.</p>
                        </div>
                    </div>
                    <div className="another__recommend__artist__content">
                        <div className="another__artist swiper-container">
                        ...
                        <div className="another__artist__arrow-left">
                            <i className="_icon _icon__arrow__w_l" />
                        </div>
                        <div className="another__artist__arrow-right">
                            <i className="_icon _icon__arrow__w_r" />
                        </div>
                    </div>
                </div>
                {/*<div className="another__artist__pages" />*/}
                <div className="another__artist__btn">
                    <button className={classNames("artist__btn", { "has-select": hasSelect })} onClick={hasSelect ? this.onSelectArtistSendConsult : null}>{hasSelect ? "추가문의" : "원하는 작가를 상단에서 체크해 주세요."}</button>
                </div>
            </div>
        );
    }
