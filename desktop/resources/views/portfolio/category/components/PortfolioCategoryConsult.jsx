...
class PortfolioCategoryConsult extends Component {
    constructor(props) {
        super(props);
    ...
    onConsult() {
        const { category, category_name } = this.props;
...
PortfolioCategoryConsult.propTypes = {
...
PortfolioCategoryConsult.defaultProps = {
    is_artist: false
};

export default PortfolioCategoryConsult;
