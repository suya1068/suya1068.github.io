...
export default class Info extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            is_disabled: true,
            // is_more: false,
            area_code: CONSTANT.AREA_CODE,
            name: props.user_name,       //check
            phone_start: "010",
            phone_center: { value: "", error: "" },
            phone_end: { value: "", error: "" },
            user_phone: props.user_phone, //check
            error: "",
            more_height: 0,
            // counsel_type: "tel",
            ///
            ...
            counselTimeTempMsg: props.counsel_time || "가능한빨리",
            counselTimeSelect: props.counsel_time || "가능한빨리",
            counsel_time: props.counsel_time || "가능한빨리",  //check
            is_write: false
        };
    ...
    componentWillMount() {
        ...
        // const { user_phone, counselTimeOption, counsel_time } = this.state;
    ...
    onCheckState(time) {
        ...
        this.setState({ is_disabled: flag });
    }
    ...
    //                     onBlur={e => this.onBlur(e, this.write_consult)}
    //                 />
    //             </div>
    //             }
    //         </div>
    ...
    onFocus(e, target) {
        ...
        // if (target && (target === this.write_phone_center || target === this.write_phone_end)) {
        //     // console.log(typeof target.classList);
        //     console.log(target.classList.value === "error_input");
        //     // console.log(target.classList.filter(name === "error_input"));
        // }
    }
    ...
    renderPhoneInfo() {
        ...
        return (
            <div className="step-content__info-phone">
                ...
                {/*<div />*/}
                {/*</div>*/}
                {/*<span>SMS로 상담받을래요!</span>*/}
                {/*</div>*/}
                {/*<div className="phone-alert">*/}
                {/*<p><span className="exclamation">!</span>연락처를 입력하시면 원하시는 시간에 상담연락을 드립니다.</p>*/}
                {/*</div>*/}
            </div>
        );
    }
    ...
    // onMore() {
    //     const target_node = this.alert_msg;
    //     const more_height = !this.state.is_more ? target_node.scrollHeight : 0;
    //
    //     this.setState(this.onSetAlert(!this.state.is_more, more_height));
    // }
    //
    // onSetAlert(flag, height) {
    //     return { is_more: flag, more_height: height };
    // }
