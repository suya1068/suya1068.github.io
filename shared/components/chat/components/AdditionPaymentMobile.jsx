...
class AdditionPaymentMobile extends Component {
    constructor(props) {
        super(props);
     ...
     */
    onPay() {
        const { payMethod, agree_pay, agree_refund, agree_info, agree_get, user_phone, user_email, user_msg } = this.state;
        ...
        if (user_phone === "") {
            ...
            const redirectUrl = `${__DOMAIN__}/users/payment/process`;
            Payment.readyToTalk(message_no, payMethod, message_type === "RESERVE_CUSTOM" ? "맞춤결제" : "추가결제", redirectUrl, user_msg)
                .then(params => {
                    if (params) {
                                ...
                                if (result.success) {
                                    API.reservations.reserveToProductPay(result.merchant_uid, { pay_uid: result.imp_uid }).then(response => {
                                        ...
                                        if (response.status === 200) {
                                            tracking.conversion();
                                            //console.log("additionPaymentMobile", response, this.state);
    ...
    render() {
        const { reserve_date, message_type, content, buy_no, price } = this.props.data;
        const {
            email,
            method,
            user_name,
        ...
        return (
            <div className={classNames("products__payment__mobile", { is__mobile: isMobile })}>
                <div className="products__payment__header">
                    ...
                    <div className="payment__header__right" onClick={() => PopModal.close()}>
                        X
                    </div>
                </div>
                ...
                <div className="products__payment__content">
                    ...
                    <div className="products__payment__info">
                        ...
                        <div className="info__text">
                            ...
                            <div className="text">
                                <span className={classNames("box", { disable: email })}>
...
AdditionPaymentMobile.propTypes = {
    data: PropTypes.shape([PropTypes.node]).isRequired
};

export default AdditionPaymentMobile;
